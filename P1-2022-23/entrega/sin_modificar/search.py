...
def depthFirstSearch(problem: SearchProblem):
    ...
    while (not frontier.isEmpty()):
        ...
        for i in expanded.list:
            if(node[0] == i[0]):
                nodeInExpanded=True #si el nodo ya esta en expanded no lo añado
                break
        
        if (not nodeInExpanded): #si no esta en expanded
            expanded.push(node)
            for child in problem.getSuccessors(node[0]):
                child=list(child)
                child.append(node[3]+[child[1]])#añado el camino al nodo desde el inicio
                child=tuple(child)
                frontier.push(child) #añado el nodo a la frontera
    ...
    while (not frontier.isEmpty()):
        ...
        if (not nodeInExpanded):
            ...
            for child in problem.getSuccessors(node[0]):
                ...
                child.append(node[3]+[child[1]])#añado el camino al nodo desde el inicio
                child=tuple(child)
                frontier.push(child,problem.getCostOfActions(child[3])) #añado el nodo a la frontera
    ...
    while (not frontier.isEmpty()):
        ...
        if (not nodeInExpanded):
            ...
            for child in problem.getSuccessors(node[0]):
                ...
                child.append(node[3]+[child[1]])#añado el camino al nodo desde el inicio
                child=tuple(child)
                frontier.push(child,problem.getCostOfActions(child[3])+heuristic(child[0],problem)) #añado el nodo a la frontera con la heuristica de A*
